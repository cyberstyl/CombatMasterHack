...
public:
	...
	auto il2cpp_method_get_param_name(uint32_t index) -> const char*
	{
		static auto il2cpp_method_get_param_name = reinterpret_cast<const char* (*)(Il2CppMethod*, uint32_t)>(Crt::il2cpp_export("il2cpp_method_get_param_name"));
		return il2cpp_method_get_param_name(this, index);
	}

	auto il2cpp_method_get_name() -> const char*
	{
		static auto il2cpp_method_get_name = reinterpret_cast<const char* (*)(Il2CppMethod*)>(Crt::il2cpp_export("il2cpp_method_get_name"));
...
public:
	...
	auto GetMethodFromName(const char* name, int arg_count = -1, const char* arg_name = "", int selected_arg = -1) -> Il2CppMethod*
	{
		...
		{
			auto method_name = method->il2cpp_method_get_name();
			//printf("%s, %s\n", method_name, name);
